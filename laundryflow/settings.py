"""Django settings for the LaundryFlow project."""
...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-laundryflow-dev-key")
...
WSGI_APPLICATION = "laundryflow.wsgi.application"
